<template>
  <div id="app">
    <H3>Vue2 Reach Rock Paper Scissors </H3>
...
const privkey1 = process.env.VUE_APP_PRIVKEY2;
const privkey2 = process.env.VUE_APP_PRIVKEY3;
